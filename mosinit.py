'''
Current clamp demo using Allen Brain's model 472430904.
...
from neuron472430904 import Neuron472430904
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron472430904(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 472430904; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-85.2242126465)
        h.fcurrent()
